 ...
 * MIT Licensed
 */
import { createButton, createIcon, createIconFromPath, createText, createSelect, createOption, createElement, createInput, createTextEditor, insertElement, attachEventFromObject } from './element';
...
export class SchemeView {
    ...
    createControlObject(pluginName, key, config) {
        let source = this.data[pluginName][key];
        let nameInput = createTextEditor({});
        let valueInput = createTextEditor({});
        let itemsElement = createElement('div', {
            className: 'input-items'
        });
        let arrayElement = createElement('section', {
...
//# sourceMappingURL=SchemeView.js.map