...
import { createSession } from './PluginSession';
export class PluginManager {
    constructor(toolbarView, debugControlView, debugAreaView, debugNavigatorView) {
    ...
    getSession() {
        return createSession(this.toolbarView, this.debugControlView, this.debugAreaView, this.debugNavigatorView);
    }
    getActivePlugin() {
