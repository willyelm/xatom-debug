  ...
  createFromDescription (element, descriptions: Array<any>) {
    ...
    descriptions.forEach((desc) => {
      if (desc.value) {
        ...
        let iconElement = createElement('i', { className: 'xatom-icon' })
        ...
        if (desc.value && desc.value.objectId) {
          let request = true;
          iconElement.classList.add('xatom-icon-arrow-right');
          iconElement.addEventListener('click', (e) => {
            let properties = itemElement.querySelector('.properties') as HTMLElement;
            if (iconElement.classList.contains('xatom-icon-arrow-right')) {
              iconElement.classList.add('active');
              iconElement.classList.remove('xatom-icon-arrow-right');
              iconElement.classList.add('xatom-icon-arrow-down');
              if (request) {
              ...
              iconElement.classList.remove('xatom-icon-arrow-down');
              iconElement.classList.add('xatom-icon-arrow-right');
